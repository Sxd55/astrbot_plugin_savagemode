...
set "REPO_SSH=git@github.com:Sxd55/astrbot_plugin_savagemode.git"
set "REPO_WEB=https://github.com/Sxd55/astrbot_plugin_savagemode"
set "KEY=%USERPROFILE%\.ssh\id_ed25519"

echo.
echo === Savage Mode upload ===
echo Working dir: %CD%
...
if errorlevel 1 (
  git commit -m "Update astrbot_plugin_savagemode"
) else (
...
echo    Name: astrbot_plugin_savagemode   Visibility: Public
